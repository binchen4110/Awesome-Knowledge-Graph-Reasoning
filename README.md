...
| **Year** |    **Model**     |                                                            **Title**                                                             |       **Venue**        |  **Scenario** |                                         **Paper**                                          |                                **Code**                                |
|:--------:|:----------------:|:--------------------------------------------------------------------------------------------------------------------------------:|:----------------------:|:-------------:|:------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------:|
|   2025   |     **Biu-MoR**      |                               **Semantic Duality in Hypergraphs: Uncertainty-aware Bipolar Evidence Aggregation for Temporal Knowledge Graph Reasoning**                                |     ESWA     | Extrapolation |    [Link](https://www.sciencedirect.com/science/article/pii/S0957417425037777)    |               [Link](https://github.com/binchen4110/Biu-MoR)           |
...
|:--------:|:-----------------:|:----------------------------------------------------------------------------------------------------------------------------------:|:---------:|:----------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------:|
| 2025 |  **ROAD**  |        **Unveiling Cross-Modal Consistency: Taming Inter- and Intra-Modal Noise for Robust Multi-Modal Knowledge Graph Completion**        |           IPM          |                     [Link](https://www.sciencedirect.com/science/article/abs/pii/S0306457325004133)                   | [Link](https://github.com/ICDM-UESTC/ROAD) |
